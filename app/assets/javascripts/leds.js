    ...
    if(all_bumpers.length > 2) 
    {
       ...
       if (all_bumpers[0].height >= all_bumpers[1].height)
       {
           ...
           if ((number_bumperslong % 1 ) === 0)
           {
                  ...
                  $(".js-elementslist").append("<li class='letterresultlist form-control'>" +"Total bumpers:  aqui"+ all_bumpers[0].description +" "+"<strong><t class='colorred js-bumperpdfnumberd'>"+number_bumperslong+"</t></strong></li>");
       ...
       else 
       {
          if (all_bumpers[1].height >= all_bumpers[0].height)
          {
             ...
             {
                  number_bumperslong = Math.floor(number_bumperslong);
                  $(".js-elementslist").append("<li class='letterresultlist form-control'>" +"Total bumpers:  aqui2"+ all_bumpers[0].description +" "+"<strong><t class='colorred js-bumperpdfnumberd'>"+number_bumperslong+"</t></strong></li>");
             ...
             {   
                 number_bumperslong = Math.floor(number_bumperslong);
                 $(".js-elementslist").append("<li class='letterresultlist form-control'>" +"Total bumpers:  aqui2"+ all_bumpers[1].description +" "+"<strong><t class='colorred js-bumperpdfnumberd'>"+number_bumperslong+"</t></strong></li>");
                 $(".js-elementslist").append("<li class='letterresultlist form-control'>" +"Total bumpers:  aqui2"+ all_bumpers[0].description +" "+"<strong><t class='colorred js-bumperpdfnumbers'>"+1+"</t></strong></li>");
